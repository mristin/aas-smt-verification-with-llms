"""Check if the LLM can infer that a unit corresponds to concept description."""
...
def main() -> int:
    ...
    for take in tqdm.tqdm(pending_takes):
        ...
        prompt = (
            f"For which of the following concept descriptions does the unit "
            f"DOES NOT correspond with its definition?\n\n"
